...
declare module _ {
     ...
     * @return {boolean} false or true
     */
    function isNil(value: any): value is boolean;
    /**
     * parameter의 타입이 number인지 판별한다.
     * @param {*} value
     * @return {boolean} false or true
     */
    function isNumber(value: any): value is boolean;
    /**
     * parameter가 Function인지 판별한다.
     * @param {*} value
     * @return {boolean} false or true
     */
    function isFunction(value: any): value is boolean;
    /**
