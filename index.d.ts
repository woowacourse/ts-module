...
declare function _(selector: string): Element;
declare module _ {
  ...
  function pick<T extends Record<string, unknown>, U extends Partial<keyof T>>(
    object: T,
    props?: U[]
  ): Pick<T, U>;
  function omit<T extends Record<string, unknown>, U extends Partial<keyof T>>(
    object: T,
    props?: U[]
  ): Omit<T, U>;
